...
profile:
  ...
  address: >
    <center>
    <p>CS PhD student at NUS</p>
    <p style="font-size:12px;">xuanlei [at] comp.nus.edu.sg</p>
    </center>
...
Moreover, I play a pivotal role in an open-source training system [Colossal-AI](https://github.com/hpcaitech/ColossalAI) (with over 35k stars on GitHub). As one of the core contributors ([ranked 5th](https://github.com/hpcaitech/ColossalAI/graphs/contributors)), I lead a MoE and a compiler project, and actively participating in the development of various parallelism strategies.
